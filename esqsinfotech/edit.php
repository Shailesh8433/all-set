  ...
  <div class="container py-5 ">
    <div class="row">
      ...
      <div class="container-fluid">
          ...
          <div class="col-lg-3 col-md-4 m-2 " id="icons" >
            ...
            <div class="col-lg-3 bg-dark col-md-4 m-2"id="icons">
        ...
        <div class="col-lg-3 col-md-4 bg-dark  m-2" id="icons">
...
<button class="btn btn-lg btn-primary" type="button"> save</button>
                  ...
                  <div class="col-lg-6 col-md-12 responsive mt-2">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3772.1309466850817!2d72.83026765101346!3d19.013950658796656!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7cec197909a0d%3A0x1a918fbfd4433ad0!2sDharwala.com!5e0!3m2!1sen!2sin!4v1616692933301!5m2!1sen!2sin" width="100%" height="460" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                 </div>
                </div>
        </div>
    </div>
...
<div id="footer-side">
    <div class="container">
        ...
        <div class="col-lg-5 col-sm-5">
            <div class="brand">
        <a href="#" class="navbar-brand text-white">ES<i class="fa fa-superpowers"></i>S  <span>INF<i class="fa fa-superpowers"></i>TECH</span></a>	
                </div>
        <div class="social">
        ...
        <i class="fa fa-instagram"></i>
            ...
            <i class="fa fa-twitter"></i>
                ...
                <div class="col-lg-3 col-sm-3 " id="nav">
                  <li><a  href="#">Home</a></li>
            ...
            <div class="col-lg-4 col-sm-4" id="add">
