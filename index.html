...
<div Id="Slider">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block img-fluid w-100" src="img/290-1500x630.jpg" alt="First slide">
        <div class="carousel-caption">
    <h5>Trusted Services Repair your Laptop & Computer</h5>
    <p> "We work with diffrrent client & provide solution to client with their Hardware and Software problem."</p>
  </div>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="img/Overheating-Server-Repair-at-TFix-in-South-London-5-1500x630.jpg" alt="Second slide">
        <div class="carousel-caption">
    ...
    <p>"Prepare For New Future Our work is presentation of our capabilities."</p>
       ...
       <div class="carousel-item">
      <img class="d-block w-100" src="img/structure%20cabling.jpg" alt="Third slide">
        <div class="carousel-caption">
    ...
    <p>"Our exprience and service is our strength."</p>
       ...
       <div class="carousel-item">
      <img class="d-block w-100" src="img/computer-repair-brisbane-bayside-1500x630.jpeg" alt="Third slide">
        <div class="carousel-caption">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="img/computer-repairs-auckland-first-slider-image-1500x630.jpg" alt="Third slide">
        <div class="carousel-caption ">
    <h5>Network Services</h5>
    <p>"Our exprience and service is our strength."</p>
  </div>
  ...
  <div class="container py-5 ">
    ...
    font-size: 30px;
      ...
      <div class="container py-5" >
          ...
          <div class="container">
          <div class="row">
              <div class="col-lg-6 col-md-12 bg-light" data-aos="fade-right">
            ...
            ESOS INFOTECH provides solutions that are feature rich, robust and scalable. It is our constant endeavour to provide customers with more value for money. ESOS INFOTECH have professional engineers who do onsite servicing for all devices. Being a service-oriented industry for a long time ESOS INFOTECH have master the art of maintaining office automation products. We offer comprehensive and non-comprehensive yearly contracts. ESOS INFOTECH is a stockist and wholesaler for mother boards, screen LCD-led, Adapters, Touch panel.
              ...
              <div class="col-md-12 col-lg-6 mt-2" id="abmg" data-aos="fade-left">
              <img src="img/cabling-systems.jpg" class="img-fluid">
              </div>
